...
public class IncomeSpecification {
    ...
    public static Specification<Income> filterIncomes(User user, List<IncomeStatus> statuses, String keyword,
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            if (keyword != null && !keyword.trim().isEmpty()) {
                ...
                predicates.add(criteriaBuilder.or(descriptionLike, batchIdLike, categoryNameLike));
            }
